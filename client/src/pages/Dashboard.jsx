...
import { faUser, faBell, faArrowUp, faArrowDown } from '@fortawesome/free-solid-svg-icons'
...
const Dashboard = () => {
  ...
  return (
    <div className='flex-grow bg-black/5'>
      {/*User Info Tab */}
      ...
      <main className='px-4 mt-4'>
        <div className='flex justify-between'>
          ...
          <section className='flex flex-col w-1/2 rounded-2xl bg-white'>
            <div className='ml-auto transform  bg-green-200 px-6 py-4 rounded-full'>
              <FontAwesomeIcon
                icon={faArrowDown}
        ...
        <aside className='flex flex-col'>
          ...
          <section className='w-full h-20 bg-white rounded-xl justify-between flex items-center mt-2'>
            ...
            <div className='text-red-500 pr-2 text-lg font-bold'>
              -#16,000
            </div>
          </section>
          <section className='w-full h-20 bg-white rounded-xl justify-between flex items-center mt-2'>
